...
('AI per Tutti', 'Introduzione alle applicazioni pratiche dell''IA per non esperti.', '2026-03-15', '10:00:00', 'Aula Magna - Edificio A', 200, 15, 'APPROVED', CURRENT_TIMESTAMP, 'photo1.jpeg', 1, 1),
('Workshop pratico di Cybersecurity', 'Esercizi pratici sulla sicurezza web e le difese.', '2026-03-20', '14:00:00', 'Laboratorio 3 - Edificio B', 30, 25, 'WAITING', CURRENT_TIMESTAMP, 'photo3.jpeg', 2, 2),
...
('Passeggiata Fotografica', 'Passeggiata guidata per migliorare le abilità nella fotografia outdoor.', '2026-04-18', '16:30:00', 'Centro Storico - Edificio B', 40, 28, 'WAITING', CURRENT_TIMESTAMP, 'photo1.jpeg', 1, 5),
('Serata Pitch Startup', 'Startup locali presentano le loro idee a mentori e investitori.', '2026-05-05', '18:00:00', 'Hub dell''Innovazione - Edificio B', 120, 35, 'WAITING', CURRENT_TIMESTAMP, 'photo1.jpeg', 2, 1),
('Gruppo di Studio ML Avanzato', 'Incontri settimanali per discutere articoli recenti e implementazioni.', '2026-05-12', '17:00:00', 'Aula 210 - Edificio B', 25, 5, 'APPROVED', CURRENT_TIMESTAMP, 'photo2.jpeg', 5, 1),
...
('Fiera Maker di Primavera', 'Esposizione di progetti studenteschi e dimostrazioni dei maker.', '2026-05-20', '11:00:00', 'Padiglione Espositivo - Edificio B', 300, 300, 'APPROVED', CURRENT_TIMESTAMP, 'photo3.jpeg', 5, 2);
